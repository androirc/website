...
namespace MDL\DeployBundle\Command;
...
The <info>project:deploy</info> command deploys a project on a server:
  ...
  <info>php app/console mdl:deploy production</info>
...
must pass the <comment>--go</comment> option:
  ...
  <info>php app/console mdl:deploy --go production</info>
EOF
            )
        ;
    }
    ...
    {
        $deployer = $this->getContainer()->get('mdl.deployer');
