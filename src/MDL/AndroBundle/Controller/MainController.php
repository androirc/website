...
use MDL\AndroBundle\Entity\Contact;
use MDL\AndroBundle\Form\ContactType;
use MDL\AndroBundle\Mobile;
...
class MainController extends MobileController
{
    public function homepageAction()
    {
        ...
        $repo = $em->getRepository('MDL\AndroBundle\Entity\Article');
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $repo = $em->getRepository('MDL\AndroBundle\Entity\Donator');
    ...
    public function tipAction($lang, $date = null)
    {
        ...
        if (null !== $date) {
            ...
            $repo = $em->getRepository('MDL\AndroBundle\Entity\TipHoliday');
            $tip = $repo->findByDate($lang, $date);
        }

        if (null === $tip) {
            $repo = $em->getRepository('MDL\AndroBundle\Entity\Tip');
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $repo = $em->getRepository('MDL\AndroBundle\Entity\QuickStart');
