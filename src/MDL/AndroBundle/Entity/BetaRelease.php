...
/**
 * @ORM\Entity(repositoryClass="MDL\AndroBundle\Repository\BetaReleaseRepository")
...
class BetaRelease
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="MDL\AndroBundle\Entity\BetaDownload", mappedBy="beta_release")
     */
    protected $downloads;
     ...
     * Add downloads
     *
     * @param MDL\AndroBundle\Entity\BetaDownload $downloads
     */
    public function addDownloads(\MDL\AndroBundle\Entity\BetaDownload $downloads)
    {
