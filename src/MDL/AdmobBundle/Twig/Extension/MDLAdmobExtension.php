...
namespace MDL\AdmobBundle\Twig\Extension;
 ...
 */
class MDLAdmobExtension extends \Twig_Extension
{
    protected $admob;
    ...
    {
        return array(
            'mdl_admob' => new \Twig_Function_Method($this, 'render', array('is_safe' => array('html')))
        );
    }
