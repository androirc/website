...
/**
 * @ORM\Entity(repositoryClass="Madalynn\Bundle\AndroBundle\Repository\BetaDownloadRepository")
...
class BetaDownload
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Madalynn\Bundle\AndroBundle\Entity\BetaRelease")
     ...
     * Set beta release
     *
     * @param Madalynn\Bundle\AndroBundle\Entity\BetaRelease $betaRelease
     */
