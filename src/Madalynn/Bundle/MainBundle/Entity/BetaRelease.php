...
/**
 * @ORM\Entity(repositoryClass="Madalynn\Bundle\MainBundle\Repository\BetaReleaseRepository")
...
class BetaRelease
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Madalynn\Bundle\MainBundle\Entity\BetaDownload", mappedBy="betaRelease")
     */
    protected $downloads;
